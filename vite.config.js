...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      registerType: 'prompt',
      injectRegister: null, // We handle registration via useRegisterSW in PWABanner
      ...
      workbox: {
        ...
        // SPA: all navigation requests fall back to the precached index.html
        navigateFallback: 'index.html',
        // Don't intercept API requests with navigateFallback
